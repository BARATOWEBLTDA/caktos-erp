    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="orb1 absolute w-96 h-96 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(147,51,234,0.4) 0%, transparent 70%)', top: '10%', left: '5%', filter: 'blur(40px)' }} />
        <div className="orb2 absolute w-80 h-80 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(196,77,240,0.35) 0%, transparent 70%)', bottom: '15%', right: '8%', filter: 'blur(50px)' }} />
        <div className="orb3 absolute w-64 h-64 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(88,28,135,0.5) 0%, transparent 70%)', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', filter: 'blur(60px)' }} />
          ...
          <button
            ...
            <div className="w-28 h-28 rounded-full overflow-hidden flex items-center justify-center shrink-0"
              style={{
                ...
                boxShadow: hovered === profile.id ? '0 0 30px rgba(196,77,240,0.6), 0 0 60px rgba(196,77,240,0.3)' : '0 4px 20px rgba(0,0,0,0.4)',
      ...
      <button onClick={handleLogout}
        className="relative z-10 mt-12 text-xs font-medium transition-all hover:opacity-100 opacity-40"
        style={{ color: 'white' }}>
        Sair da conta
      </button>

      <p className="relative z-10 mt-4 text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
