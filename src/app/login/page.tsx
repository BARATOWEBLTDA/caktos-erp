...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div className="flex flex-1 lg:max-w-md xl:max-w-lg items-center justify-center"
        ...
        <div className="w-full max-w-sm px-6 py-8 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white text-center" style={{ fontFamily: 'Sora, sans-serif' }}>
              CAKTOS MAKEUP
            </h1>
          ...
          <form onSubmit={handleLogin} className="w-full space-y-4">
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                placeholder="seu@email.com" required className="input-base"
                style={{ background: 'rgba(255,255,255,0.04)', borderColor: 'rgba(255,255,255,0.08)', color: 'white' }} />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} value={password}
                  ...
                  placeholder="••••••••" required className="input-base pr-11"
                  style={{ background: 'rgba(255,255,255,0.04)', borderColor: 'rgba(255,255,255,0.08)', color: 'white' }} />
                <button type="button" onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: 'rgb(120 105 150)' }}>
